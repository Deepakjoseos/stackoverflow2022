...
const Tags = () => {
  const tagslist = [{
    ...
    id:4,
    tagName:"java",
    tagDesc:"ava is a high-level object oriented programming language. Use this tag when you're having problems using or understanding the language itself."
  },{
    id:5,
    tagName:"php",
  ...
  return (
    <div className="home-container-1">
            <LeftSidebar />
            <div className="container-tags-2">
                <h1>Tags</h1>
